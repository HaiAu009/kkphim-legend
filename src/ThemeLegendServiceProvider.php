    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'legend' => [
                ...
                'package_name' => 'haiau009/kkphim-legend',
                ...
                'options' => [
                    ...
                    [
                        ...
                        <div class="bar">
                            <div class="bar-wrap">
                                <div class="links">
                                    <img src="https://" alt="KKPhimCMS" />
                                    <br>
                                    <div class="copyright">Copyright 2022 © <a href="/" title="KKPhimCMS">KKPhimCMS</a>
                                        <br />
                                        <p>
